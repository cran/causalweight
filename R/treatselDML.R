...
#' @param k Number of folds in k-fold cross-fitting, which must not be smaller than 3. Default is 3.
...
#' @references Bia, M., Huber, M., Laffers, L. (2024): "Double machine learning for sample selection models", Journal of Business & Economic Statistics, 42, 958-969.
